...
{
    public class RxNumComputePredictResult : BasePredictData
    {
        public RxNumComputePredictResult(IDictionary<int, double> predictedDataRate) : base(predictedDataRate)
        {
        }
